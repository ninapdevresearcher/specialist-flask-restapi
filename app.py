...
class AuthorModel(db.Model):
   ...
   __table_args__ = (db.UniqueConstraint('name', 'surname', name='fullname'),)
...
def edit_author(author_id):
    ...
    if author is None:
        abort(404)
    elif len(author_data["name"]) == 0 and len(author_data["surname"]) == 0:
        return "To edit, enter the first and/or last name of the author."
    if len(author_data["name"]) != 0:
...
def create_quote(author_id):
    ...
    if int(new_quote['rating']) > 5:
        new_quote['rating'] = '5'
    elif int(new_quote['rating']) <= 0:
        new_quote['rating'] = '1'
...
#     name = request.args.get('name', default=None, type=None)
#     surname = request.args.get('surname', default=None, type=None)
#     rating = request.args.get('rating', default=None, type=None)
#     text = request.args.get('text', default=None, type=None)
...
#     # quotes = QuoteModel.query.join(QuoteModel.author).filter(QuoteModel.name == 'Tom')
